    ...
    buttons: [
      {
        ...
        label: {
          image: `/media/icons/warcraft-logs-logo.png`,
          alt: "Warcraft Logs",
        },
      ...
      },
      {
        ...
        label: {
          image: `/media/icons/warcraft-icon.png`,
          alt: "Wow Armory",
        },
        tooltip: "Wow Armory",
      },
      {
        ...
        label: {
          image: `/media/icons/curse-icon.png`,
          alt: "Wow Progress",
        },
      ...
      },
      {
        ...
        label: {
          image: `/media/icons/raiderio_logo.png`,
          alt: "Raider.io",
        },
        tooltip: "Raider.io",
      },
